...
ones: ``goal`` (target sets x reps), ``media`` (images/video links) and
``muscle_engagement`` (free-form ``{muscle_name: percent}`` dict --
adding a new muscle does not require a schema migration).
